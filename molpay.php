...
class MOLPay extends PaymentModule {
	...
	private $molpay_channels = array(
		...
		'BOOST' 			=> array('name' => "Boost", 'logo' => "https://www.molpay.com/v3/images/molpay/channel/BOOST.png", 'currency' => array("MYR"))
	);
	...
	public function uninstall() {
		...
		if(!Configuration::deleteByName('MOLPAY_MERCHANT_VKEY') || 
			!Configuration::deleteByName('MOLPAY_MERCHANT_PVKEY') || 
			!Configuration::deleteByName('MOLPAY_MERCHANT_ACCTYPE') || 
			!Configuration::deleteByName('MOLPAY_MERCHANT_ID') || 
			!Configuration::deleteByName('MOLPAY_SEAMLESS_JS') || 
			!parent::uninstall())
			return false;
		else
			return true;
	...
	protected function _postProcess() {
		if(isset($_POST['btnSubmit'])) {
			...
			Configuration::updateValue('MOLPAY_SEAMLESS_JS', Tools::getValue('merchant_acctype')."MOLPay/API/seamless/3.20/js/MOLPay_seamless.deco.js");
			...
			'form' => array(
				...
				'input' => array(
					...
					array(
						...
						'value' => 'https://www.onlinepayment.com.my/MOLPay/API/seamless/3.20/js/MOLPay_seamless.deco.js',
						//'readonly' => 'readonly',
						'required' => true
					),
				),
